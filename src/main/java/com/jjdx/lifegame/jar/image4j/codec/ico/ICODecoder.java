...
public class ICODecoder {
    ...
    public static List<BufferedImage> read(File var0) throws IOException {
        ...
        List<BufferedImage> var2;
        try {
            var2 = read(new BufferedInputStream(var1));
        } finally {
            try {
                var1.close();
    ...
    public static List<BufferedImage> read(InputStream var0) throws IOException {
        List<ICOImage> var1 = readExt(var0);
        ArrayList<BufferedImage> var2 = new ArrayList<>(var1.size());

        for (ICOImage object : var1) {
            var2.add(object.getImage());
        }
    ...
    public static List<ICOImage> readExt(InputStream var0) throws IOException {
        ...
        byte var32 = 0;
        ArrayList<ICOImage> var7 = new ArrayList<>(var4);
        ...
        try {
            for (var6 = 0; var6 < var4; ++var6) {
                ...
                if (var9 != 40) {
                    ...
                    ICOImage var54 = new ICOImage(var50, null, var52);
    ...
    private static ImageReader getPNGImageReader() {
        ...
        Iterator<ImageReader> var1 = ImageIO.getImageReadersByFormatName("png");
        if (var1.hasNext()) {
            var0 = var1.next();
        }
        return var0;
